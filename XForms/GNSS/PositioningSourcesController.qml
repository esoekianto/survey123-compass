...
Item {
    ...
    property bool preventReconnect
...
//            }
    ...
    Connections {
        ...
        onConnectedChanged: {
            if (currentDevice && useExternalGPS) {
                if (stayConnected && !preventReconnect) {
                    reconnect();
                }
            }
        }
    ...
    Connections {
        ...
        onRunningChanged: {
            ...
            if (useExternalGPS && !discoveryAgent.running && !isConnecting && !isConnected && stayConnected && !preventReconnect) {
