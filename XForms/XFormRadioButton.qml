    ...
    style: RadioButtonStyle {
        ...
        label: Item {
            ...
            Rectangle {
                ...
                height: 6 * AppFramework.displayScaleFactor
        ...
        indicator: Rectangle {
            width:  Math.round(xform.style.implicitTextHeight)
            height: width
            gradient: Gradient {
        ...
        panel: Item {
            ...
            GridLayout {
                ...
                Loader {
                    ...
                    Layout.preferredHeight: Math.round(xform.style.implicitTextHeight)
