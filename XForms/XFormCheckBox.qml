...
CheckBox {
    ...
    style: CheckBoxStyle {
        ...
        spacing: Math.round(xform.style.implicitTextHeight / 4)

        label: Item {
            implicitWidth: text.implicitWidth + 2 * AppFramework.displayScaleFactor
            implicitHeight: text.implicitHeight
            baselineOffset: text.baselineOffset

            Rectangle {
                anchors.fill: text
                anchors.margins: -1 * AppFramework.displayScaleFactor
                anchors.leftMargin: -3 * AppFramework.displayScaleFactor
                anchors.rightMargin: -3 * AppFramework.displayScaleFactor
        ...
        indicator: Item {
            implicitWidth: Math.round(xform.style.implicitTextHeight)
            height: width
            Rectangle {
                anchors.fill: parent
                anchors.bottomMargin: -1 * AppFramework.displayScaleFactor
                color: "#44ffffff"
            ...
            Rectangle {
                ...
                radius: xform.style.implicitTextHeight * 0.16
                anchors.fill: parent
            ...
            Rectangle {
                ...
                radius: baserect.radius - 1 * AppFramework.displayScaleFactor
        ...
        panel: Item {
            ...
            RowLayout {
                ...
                Loader {
                    id: indicatorLoader
                    Layout.preferredHeight: 15 * AppFramework.displayScaleFactor * xform.style.textScaleFactor
