...
Rectangle {
    ...
    function resizeImageObject(imageObject) {
        ...
        if (imageRatio < canvasRatio) {
            imageObject.scaleToHeight(canvas.height * scaleFactor, ImageObject.TransformationModeSmooth);
        } else {
            imageObject.scaleToWidth(canvas.width * scaleFactor, ImageObject.TransformationModeSmooth);
        }
