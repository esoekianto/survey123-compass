...
App {
    ...
    property var numberLocale: locale
    ...
    Component.onCompleted: {
        ...
        console.log("Surveys folder:", surveysFolder.path);
        ...
        console.log("offlineStoragePath:", AppFramework.offlineStoragePath)
...
//                    }
    ...
    function checkClipboard() {
        ...
        if (urlInfo.scheme === "arcgis-survey123") {
