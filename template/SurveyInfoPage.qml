            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    AppText {
                        ...
                        text: qsTr("By %1").arg(surveyInfo.owner)
                    ...
                    AppText {
                        ...
                        text: qsTr("Created: %1").arg(surveyInfo.created.toLocaleDateString(app.locale, Locale.ShortFormat))
                    ...
                    AppText {
                        ...
                        text: qsTr("Last modified: %1").arg(surveyInfo.modified.toLocaleDateString(app.locale, Locale.ShortFormat))
